...
parser.add_argument('-j', default='/data8T/miki/xinye/preliminary/train/b_annotations.json', help='JSON file', dest='json')
parser.add_argument('-o', default='/data8T/miki/xinye/preliminary/train/b_labels', help='path to output folder', dest='out')
parser.add_argument('-cls', default='xinye_b.names', help='clsses name')
...
class COCO2YOLO:
    ...
    def coco2yolo(self):
        ...
        print('start save classes ...')
        self.save_classes()
        print('save classes done')
